...
fileorig="${standard}_emulation_grouping.m"

for quantization_val in $quantization_values ; do

filenew="${name_dir}/${standard}_${chanBW}_${NumAnts}x${NumAnts}_emulation_quantization_${quantization_val}_grouping_${subc_group}.m"
