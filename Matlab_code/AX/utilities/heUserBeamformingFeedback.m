...
chanEstUser = wlanHELTFChannelEstimate(demodHELTFRU,cfgNDP);

% Get cyclic shift and inverse
numTx = cfgNDP.NumSpaceTimeStreams; % The sounding packet is configured for one space-time stream per antenna
