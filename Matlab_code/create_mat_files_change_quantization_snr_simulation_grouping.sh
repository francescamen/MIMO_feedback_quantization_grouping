...
fileorig="${standard}_simulation_grouping.m"

for quantization_val in $quantization_values ; do

filenew="${name_dir}/${standard}_${NumAnts}x${NumAnts}_simulation_quantization_${quantization_val}_grouping_${subc_group}.m"
