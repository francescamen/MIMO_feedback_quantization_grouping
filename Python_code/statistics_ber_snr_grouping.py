...
if __name__ == '__main__':
    ...
    parser.add_argument('grouping', help='grouping', type=int)
    ...
    for standard_name in standard_values:
        ...
        for sub_fold in sub_folders:
            ...
            if corrupted:
                name_save_file = name_save_file + 'corrupted_feedback.txt'
            else:
            ...
            for snr_val in snr_values:
                ...
                if corrupted:
                    name_folder = name_folder + 'corrupted_feedback'
